...
def strnmldict(nmlall, fmt='', masterswitch='', hide={}):
    """
...
def latexdict(nmlall, masterswitch='', hide={}, heading='', url=''):
    """
    Return complete latex representation of dict of Namelists.
    ...
    heading : string, optional, default=''
        string to be written above table.

    url : string, optional, default=''
        url prefix for hyperlinked variables and groups.
    ...
    st += '\n'
    st += strnmldict(nmlall, fmt='latex', masterswitch=masterswitch, hide=hide)
    # st += '}}'
    st += textwrap.dedent(r"""
    \clearpage
            ...
            if fmt == 'latex-complete':
                if diff:
                    ...
                    heading = textwrap.dedent(r"""
                        ...
                        \ignored{Greyed values} are ignored.
                        """)
                print(latexdict(nmld, masterswitch='use_this_module',
